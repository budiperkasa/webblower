...
<div id="showcase-<?php echo $widget_id; ?>" class="wk-slideshow-showcaseboxcloud">
...
<script type="text/javascript">
	...
	jQuery(function($){
		...
		$.widgetkit.lazyloaders.showcase($("#showcase-<?php echo $widget_id; ?>"), <?php echo json_encode($settings); ?>);
	});
