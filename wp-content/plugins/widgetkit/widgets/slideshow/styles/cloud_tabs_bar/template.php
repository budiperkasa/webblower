...
<div id="slideshow-<?php echo $widget_id; ?>" class="wk-slideshow wk-slideshow-tabsbarcloud">
...
<script type="text/javascript">
	...
	jQuery(function($){
		...
		$.widgetkit.lazyloaders.slideshow($("#slideshow-<?php echo $widget_id; ?>"), <?php echo json_encode($settings); ?>);
	});
