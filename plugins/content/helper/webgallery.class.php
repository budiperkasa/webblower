...
class webGalleryThumbnail {
    ...
    *@return boolean
    **/
	public function webGalleryThumbnail($imgfile) 	{
    ...
    **/
    public function CalculateQFactor($size)  {
    ...
    *@return integer
    **/
    public function calc_text_position_H () {
    ...
    *@return integer
    **/
    public function calc_text_position_V () {
    ...
    *@return integer
    **/
    public function calc_position_H () {
    ...
    *@return integer
    **/
    public function calc_position_V () {
    ...
    **/
    public function unique_filename ( $archive_dir , $filename , $file_prefix='') {
        ...
        **/
        public function imagemergealpha($i) {
