...
if ($item_count = count($items)) {
	...
	$zoo->path->register(dirname(__FILE__), 'mod_zooscroller');
	...
	$zoo->document->addStyleSheet('mod_zooscroller:mod_zooscroller.css.php');
	$zoo->document->addScript('mod_zooscroller:mod_zooscroller.js');
