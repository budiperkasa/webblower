...
// include css
$zoo->document->addStylesheet('mod_zoocomment:tmpl/bubble-angled-h/style.css');
...
if ($is_ie7) $zoo->document->addStylesheet('mod_zoocomment:tmpl/bubble-angled-h/iehacks.css');
