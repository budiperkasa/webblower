...
if ($item_count = count($items)) {
	...
	$zoo->path->register(dirname(__FILE__), 'mod_zoocarousel');
	...
	$zoo->document->addStyleSheet('mod_zoocarousel:mod_zoocarousel.css.php');
	$zoo->document->addScript('mod_zoocarousel:mod_zoocarousel.js');
